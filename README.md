...
本项目是一个面向计算档案学的智能叙事生成系统。用户输入一个档案主题（如"南仁东""红色档案""非遗档案"），系统自动完成：

1. **网络爬取** — 多引擎搜索并爬取相关图文资料
2. **图片下载与验证** — 下载图片、内容去重、尺寸过滤、视觉模型验证相关性
3. **档案分析** — LLM 提取人物、时间线、关联关系、精神主题，生成结构化叙事
4. **图片智能分配** — 视觉语义匹配，为人物配肖像、为事件配场景图
5. **双端展示** — 生成叙事网页 + Three.js 3D 虚拟展厅
